package com.example.githuboauth2.service;

import com.example.githuboauth2.OAuth2Attributes;
...
@Service
public class CustomOAuthService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> { // OAuth2의 핵심
